...
<head>
  <meta charset="utf-8" />
  <title>Sistema de Factura Electr&oacute;nica Infosys | Página Acceso</title>
...
<div class="login-cover">
  <div class="login-cover-image"><img src="<?=base_url();?>assets/img/login-bg/bgf2.jpg" data-id="login-cover-image" alt="" /></div>
...
<div id="page-container" class="fade">
  ...
  <div class="login login-v2" data-pageload-addclass="animated fadeIn">
    ...
    <div class="login-header">
      <div class="brand">
        <span class="logo"></span>Factura Electr&oacute;nica
        <small>Acceso a sistemas de Factura Electr&oacute;nica Infosys</small>
      </div>
      <div class="icon">
