...
*/
$config['tables']['users']           = 'fe_users';
$config['tables']['groups']          = 'fe_groups';
$config['tables']['users_groups']    = 'users_groups';
$config['tables']['login_attempts']  = 'login_attempts';
$config['tables']['level']  = 'fe_level';
$config['tables']['role']  = 'fe_role';
$config['tables']['app']  = 'fe_app';
$config['tables']['menu']  = 'fe_menu';
